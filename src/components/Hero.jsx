...
<section
  id="home"
  className="relative pt-20 pb-16 md:pt-32 md:pb-24 overflow-hidden bg-center bg-cover bg-no-repeat"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <motion.h1
            ...
            className="text-m md:text-l lg:text-xl font-light mb-4  text-gray-400 dark:text-gray-500"
          >
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h2 className="text-xl md:text-2xl text-gray-800 dark:text-gray-300">
          ...
          <motion.p
            ...
            className="max-w-2xl text-gray-600 dark:text-gray-400 mb-10 text-lg"
          >
